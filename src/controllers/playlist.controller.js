...
const createPlaylist = asyncHandler(async (req, res) => {
  ...
  // Create a new playlist (videos are optional)
...
const getUserPlaylists = asyncHandler(async (req, res) => {
  ...
  // Find all playlists owned by the user and populate the videos field
...
const getPlaylistById = asyncHandler(async (req, res) => {
  ...
  // Find the playlist and populate the videos field
